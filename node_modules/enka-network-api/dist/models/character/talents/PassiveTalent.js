...
class PassiveTalent {
    ...
    static getById(id, enka) {
        var _a;
        const json = (_a = enka.cachedAssetsManager.getGenshinCacheData("ProudSkillExcelConfigData").findArray((_, p) => p.getAsNumber("proudSkillId") === id)) === null || _a === void 0 ? void 0 : _a[1];
        if (!json)
            throw new AssetsNotFoundError_1.default("Talent", id);
        return new PassiveTalent(json.getAsJsonObject(), enka);
    }
}
exports.default = PassiveTalent;
